...
export const sidebarMenu = [
	...
	},
	{
		...
		activeIcon: (
			<AiOutlineSearch className="text-2xl mr-5"></AiOutlineSearch>
		),
	},
	{
		title: "Explore",
	...
	},
	{
		title: "Create",
		icon: (
			<AiOutlinePlusCircle className="text-2xl mr-5"></AiOutlinePlusCircle>
		),
		activeIcon: (
			<AiFillPlusCircle className="text-2xl mr-5"></AiFillPlusCircle>
		),
	},
	{
		title: "Profile",
